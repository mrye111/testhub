    ...
    <div class="showcase-section">
      ...
      <div class="showcase-content">
        ...
        <div class="pill-group">
          <span class="pill-btn" v-for="(pill, index) in pills" :key="index">
      ...
      <div class="login-form-wrapper">
        ...
        >
          ...
          <div class="form-footer">
            ...
            <router-link to="/register" class="register-link">{{ $t('auth.signUpNow') }}</router-link>
          </div>
        </el-form>
...
.custom-input-group {
  ...
  :deep(.el-form-item) {
    ...
    .el-input__wrapper {
      ...
      &.is-focus {
        box-shadow: 0 0 0 1px #000, 0 0 0 3px rgba(0, 0, 0, 0.06) !important;
      }
    }
...
@media (max-width: 640px) {
  .showcase-section {
    ...
    .brand-header .logo-group .brand-title {
      font-size: 28px;
    }
  }
